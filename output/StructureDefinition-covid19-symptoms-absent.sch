...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'http://fhir.logicahealth.org/covid19/StructureDefinition/certainty-of-absence']) &gt;= 1">extension with URL = 'http://fhir.logicahealth.org/covid19/StructureDefinition/certainty-of-absence': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.logicahealth.org/covid19/StructureDefinition/certainty-of-absence']) &lt;= 1">extension with URL = 'http://fhir.logicahealth.org/covid19/StructureDefinition/certainty-of-absence': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
