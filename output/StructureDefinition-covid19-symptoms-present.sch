...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      <sch:assert test="count(f:extension[@url = 'http://fhir.logicahealth.org/covid19/StructureDefinition/certainty-of-presence']) &lt;= 1">extension with URL = 'http://fhir.logicahealth.org/covid19/StructureDefinition/certainty-of-presence': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
