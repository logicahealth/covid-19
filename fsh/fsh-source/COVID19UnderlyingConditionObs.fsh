...
* component[COVID19UnderlyingMedicalCondition].value only CodeableConcept
...
* component[COVID19UnderlyingCardiovascularMedicalCondition].value only CodeableConcept
...
* component[COVID19UnderlyingNeuroligicMedicalCondition].value only CodeableConcept
...
* component[COVID19UnderlyingImmunocompromisedMedicalCondition].value only CodeableConcept
...
* component[COVID19RespiratoryUnderlyingMedicalCondition].value only CodeableConcept
...
* component[COVID19UnderlyingMetabolicMedicalCondition].value only CodeableConcept
...
* component[COVID19HemoglobinopathyUnderlyingMedicalCondition].value only CodeableConcept
...
* component[COVID19RenalUnderlyingMedicalCondition].value only CodeableConcept
...
* component[COVID19ImmuneUnderlyingMedicalCondition].value only CodeableConcept
...
* component[COVID19GastrointestinalHepaticUnderlyingMedicalCondition].value only CodeableConcept
...
* component[COVID19UncategorizedUnderlyingMedicalCondition].value only CodeableConcept
