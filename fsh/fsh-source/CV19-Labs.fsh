...
Profile:  SARScoronavirus2NgenePrThrPtXXXOrdPrbAmpTarPrimerProbeSetN1LabObs
Parent:   CodedLaboratoryObservationBase
Title:    "SARS coronavirus 2 Ngene Pr Thr Pt XXX Ord Prb Amp" // is this correct? It is a duplicate
...
Profile:  SARScoronavirus2NgenePrThrPtXXXOrdPrbAmpTarPrimerProbeSetN2LabObs
Parent:   CodedLaboratoryObservationBase
Title:    "SARS coronavirus 2 Ngene Pr Thr Pt XXX Ord Prb Amp"  // is this correct? It is a duplicate
...
Profile:  SARScoronavirus2NgeneThreshNumPtXXXQnPrbAmpTarPrimerProbeSetN1LabObs
Parent:   QuantitativeLaboratoryObservationBase
Title:    "SARS coronavirus 2 Ngene Thresh Num Pt XXX Qn Prb Amp"
Description: "SARScoronavirus2NgeneThreshNumPtXXXQnPrbAmpTarPrimerProbeSetN1LabObs is a quantitative test for the SARS coronavirus 2 N gene via the probe target amplification, primer probe set N1 method in non-respiratory specimens. LOINC code 94311-8."
* ^abstract = false
* code = LNC#94311-8
// missing units of measure

Profile:  SARScoronavirus2NgeneThreshNumPtXXXQnPrbAmpTarPrimerProbeSetN2LabObs
Parent:   QuantitativeLaboratoryObservationBase
Title:    "SARS coronavirus 2 Ngene Thresh Num Pt XXX Qn Prb Amp"
Description: "SARScoronavirus2NgeneThreshNumPtXXXQnPrbAmpTarPrimerProbeSetN2LabObs is a quantitative test for the SARS coronavirus 2 N gene via the probe target amplification, primer probe set N2 method in non-respiratory specimens. LOINC code 94312-6."
* ^abstract = false
* code = LNC#94312-6
// missing units of measure
...
Description: "SARScoronavirus2RdRpGenePrThePtRespOrdPrbAmpTar is a test for the SARS coronavirus 2 RdRp gene in respiratory spsecimens. LOINC code 94534-5."
* ^abstract = false
* code = LNC#94534-5
// missing value set
...
* code = LNC#94531-1
* hasMember contains
    Reference(SARScoronavirus2NGenePrThrPtRespOrdPrbAmpTarLabObs) 0..1 and
    Reference(SARScoronavirus2RdRpGenePrThePtRespOrdPrbAmpTarLabObs) 0..1 and
    Reference(SARScoronavirus2RNAPrThrPtRespOrdPrbAmpTarLabObs) 0..1
...
* code = LNC#94306-8
* hasMember contains
    Reference(SARScoronavirus2NgeneThreshNumPtXXXQnPrbAmpTarPrimerProbeSetN1LabObs) 0..1 and
    Reference(SARScoronavirus2NgeneThreshNumPtXXXQnPrbAmpTarPrimerProbeSetN2LabObs) 0..1
...
Profile:  SARSrelatedcoronavirusPlusMERScoronavirusRNAPrThrPtRespOrdPrbAmpTarLabObs
Parent:   CodedLaboratoryObservationBase
